class Historical:
    ...
    def __repr__(self):
        return f"Historical(MesAno='{self.mes_ano}', PrevisaoCasos={self.previsao_casos}, PrevisaoMinima='{self.previsao_minima_casos}, PrevisaoMaxima='{self.previsao_maxima_casos}')"
